...
class Kepsek extends Model
{
     ...
     * Meng-encode ID (misal: 1) menjadi hash (misal: 'bC1dE2fG3h')
     */
     ...
     * Menerjemahkan hash (misal: 'bC1dE2fG3h') kembali menjadi ID (misal: 1)
     */
    public function resolveRouteBinding($value, $field = null)
    {
        ...
        // Cari data kepala sekolah berdasarkan ID asli
